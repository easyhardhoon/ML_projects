...
def make_extras_X():
    ...
    #cfg = [1024, 2048, 1024, 2048, 1024, 2048, 1024, 2048]
    cfg = [128,128,128,128, 2048, 1024, 2048, 1024, 2048, 1024, 2048]

    layers += [nn.Conv2d(in_channels, cfg[0], kernel_size=(1))]
    layers += [nn.Conv2d(cfg[0], cfg[1], kernel_size=(1))]
    layers += [nn.Conv2d(cfg[1], cfg[2], kernel_size=(1))]
    layers += [nn.Conv2d(cfg[2], cfg[3], kernel_size=(1))]
    layers += [nn.Conv2d(cfg[3], cfg[4], kernel_size=(3), stride=2, padding=1)]
    ...
    layers += [nn.Conv2d(cfg[7], cfg[8], kernel_size=(3))]
...
def make_loc_conf(num_classes=21, bbox_aspect_num=[6,6,6,6,4,4,4]):
    ...
    loc_layers += [nn.Conv2d(64, bbox_aspect_num[3]
                             * 4, kernel_size=3, padding=1)]
    conf_layers += [nn.Conv2d(64, bbox_aspect_num[3]
                              * num_classes, kernel_size=3, padding=1)]
